...
public class HttpRequestHelper {
    ...
    private static final String POP_CONFIGS_URL = "%s/sfo/user_popup_configs/%s?project=%s&platform=%s";
    /* /popup_displays/{popup_display_uuid} */
    private static final String POP_DISPLAY_URL = "%s/sfo/popup_displays/%s?project=%s";
    /* /popup_displays/{popup_display_uuid} */
    ...
    private static final String POP_INFO_URL = "%s/sfo/popup_windows/%s?project=%s";
    ...
    public String pullEventConfig(String distinct_id) {
        try {
            String httpUrl = String.format(POP_CONFIGS_URL, mBaseUrl, distinct_id, getProject(), PLATFORM_TYPE);
     ...
     */
    public void pullWindowState(String popup_display_uuid, HttpCallBack httpCallBack) {
        try {
    ...
    public void pullWindowInfo(String popup_window_id, HttpCallBack httpCallBack) {
        try {
            String httpUrl = String.format(POP_INFO_URL, mBaseUrl, popup_window_id, getProject());
