/*
 * Created by dengshiwei on 2020/03/06.
...
public abstract class RoundedBitmapDrawable extends Drawable {
    ...
    public void draw(Canvas canvas) {
        ...
        if (mPaint.getShader() == null) {
            ...
            if (!isCornerAll) {
                Rect block = new Rect(0, (int) (mDstRect.height() - mCornerRadius), (int) mCornerRadius, mDstRect.height());
                canvas.drawRect(block, mPaint);
                block = new Rect((int) (mDstRect.width() - mCornerRadius), (int) (mDstRect.height() - mCornerRadius), mDstRect.width(), mDstRect.height());
                canvas.drawRect(block, mPaint);
            }
        }
    }
    ...
    RoundedBitmapDrawable(Resources res, Bitmap bitmap, boolean isCornerAll) {
        if (res != null) {
            mTargetDensity = res.getDisplayMetrics().densityDpi;
        }
        this.isCornerAll = isCornerAll;
        mBitmap = bitmap;
        if (mBitmap != null) {
            computeBitmapSize();
